...
const ProductDetails = ({ productId }) => {
  ...
  const handleQuantityChange = (action) => {
    ...
    setQuantity((prev) => {
      if (action === 'plus') return prev < selectedProduct.countInStock ? prev + 1 : prev;
  ...
  const handleAddToCart = () => {
    ...
    if (quantity > selectedProduct.countInStock) {
      toast.error(`Only ${selectedProduct.countInStock} item(s) in stock.`, {
        duration: 1500,
      });
      return;
    }
        ...
        <div className='max-w-6xl mx-auto bg-white rounded-lg'>
          <div className='flex flex-col md:flex-row'>
            ...
            <div className='md:w-1/2'>
              <img src={mainImage} alt='Main Product' className='w-full lg:h-[700px] object-cover rounded-lg mb-2' />
            </div>
            {/* Mobile Thumbnails */}
            ...
            <div className='md:w-1/2 md:ml-10'>
              ...
              <p className='text-sm lg:text-lg tracking-tight text-gray-700 mb-4'>{selectedProduct.description}</p>
                ...
                <table className='w-full text-left text-sm text-gray-600'>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className='py-1'>{isOutOfStock ? 'Out of Stock' : `${selectedProduct.countInStock}`}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
