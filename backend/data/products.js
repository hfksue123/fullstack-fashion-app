...
const products = [
  ...
  {
    name: "Leather Belt",
    description: "Genuine leather belt with a sleek metal buckle. A timeless accessory for any outfit.",
    price: 25,
    discountPrice: 35,
    countInStock: 50,
    sku: "AC-001",
    ...
    sizes: ["S", "M", "L"],
    colors: ["Black", "Brown"],
    collections: "Classic Essentials",
    material: "Leather",
    gender: "Unisex",
    images: [
      {
  ...
  {
    name: "Tote Handbag",
    description: "Spacious tote handbag with inner compartments for everyday use.",
    price: 80,
    discountPrice: 95,
    countInStock: 15,
    sku: "BG-001",
